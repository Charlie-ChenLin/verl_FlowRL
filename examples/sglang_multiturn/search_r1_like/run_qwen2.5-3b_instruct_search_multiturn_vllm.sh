...
export VLLM_USE_V1=1   # vLLM 0.8.5 默认已用 V1，引这个环境变量更稳
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4 python3 -m verl.trainer.main_ppo \
  ...
  actor_rollout_ref.actor.lr_warmup_steps_ratio=0.285 \
  ...
  trainer.project_name='search_r1_like_async_rl_vllm' \
