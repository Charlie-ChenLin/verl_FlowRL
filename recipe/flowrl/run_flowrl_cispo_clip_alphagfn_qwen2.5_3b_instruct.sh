...
MODEL_PATH='/mnt/shared-storage-user/formalverification-shared/openai-community/Qwen/Qwen2.5-3B-Instruct'
...
python3 -m recipe.flowrl.main_flowrl \
    ...
    actor_rollout_ref.actor.alphagfn_alpha=${alphagfn_alpha} \
